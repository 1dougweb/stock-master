    ...
    @else
        <div class="mb-4">
            <div class="flex flex-col md:flex-row gap-4">
                <div class="flex-1">
                    <x-input type="search" wire:model.debounce.300ms="search" placeholder="Buscar categorias..." class="w-full"/>
                </div>
            </div>
        </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead>
                <tr>
                    ...
                    <th wire:click="sortBy('products_count')" class="px-6 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer">
                        Produtos
                        @if ($sortField === 'products_count')
                            <span class="ml-1">{{ $sortDirection === 'asc' ? '↑' : '↓' }}</span>
                        @endif
                    </th>
                    <th wire:click="sortBy('sku_prefix')" class="px-6 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer">
                        Prefixo SKU
